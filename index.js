...
function predecir() {
    ...
    var valor = imgData.data[p + 3] / 255; //Se normaliza la imagen
    arr28.push([
    valor]); //Agregar al arr28 y normalizar a 0-1. Aparte queda dentro de un arreglo en el indice 0... again
    if (arr28.length == 28) {
        arr.push(arr28);
        arr28 = [];
    }
    ...
    var resultados = modelo.predict(tensor4);
    //var mayorIndice = resultados.indexOf(Math.max.apply(null, resultados));
    var mayorIndice = resultados.argMax(-1).dataSync()[0];

    const clases = ['Camiseta/top', 'Pantalón', 'Sudadera', 'Vestido', 'Abrigo', 'Sandalias', 'Camisa', 'Tenis',
    'Bolso', 'Bota tobillera'
    ];
    console.log("Prediccion", mayorIndice);
    document.getElementById("resultado").innerHTML = 'Predicción: ' + clases[mayorIndice];;
}
